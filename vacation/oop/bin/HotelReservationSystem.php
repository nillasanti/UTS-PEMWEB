...
$firstGuest = new Guest("Georgi", "Dimitrov", 12548789);
$secondGuest = new Guest("Todor", "Jivkov", 2165418);
$thirdGuest = new Guest("Georgi", "Parvanov", 89466466);
$firstReservation = new Reservation("19-10-2014", "21-10-2014", $firstGuest);
